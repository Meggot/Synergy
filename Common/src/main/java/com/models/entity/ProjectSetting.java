...
public class ProjectSetting extends EntityObject {
    ...
    @Id
    @SequenceGenerator(name="project_settings_seq", sequenceName = "project_settings_seq")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "project_settings_seq")
    private int id;
    @OneToOne
